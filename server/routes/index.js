...
router.get("/api/goods/search",function(req, res, next) {
	...
	connection.query("select * from goods_search where name like '%大姨%' order by pprice desc", function (error, results, fields) {
  ...
  res.json({
	  ...
	  data:[
		  ...
		  },
		  {
			  type:"iconsList",
			  data:[
				  {imgUrl:"../../static/img/icons1.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons2.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons3.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons4.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons5.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons6.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons7.png",name:"鞋靴箱包"},
				  {imgUrl:"../../static/img/icons8.png",name:"鞋靴箱包"}
			  ]
		  },
		  {
			  type:"hotList",
  ...
  res.json({
	  ...
	  data:[
		  ...
		  },
		  {
			  type:"iconsList",
			  data:[
				  {imgUrl:"../../static/img/icons1.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons2.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons3.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons4.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons5.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons6.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons7.png",name:"美妆个护"},
				  {imgUrl:"../../static/img/icons8.png",name:"美妆个护"}
			  ]
		  },
		  {
			  type:"hotList",
  ...
  res.json({
	  ...
	  data:[
		  ...
		  },
		  {
			  type:"iconsList",
			  data:[
				  {imgUrl:"../../static/img/icons1.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons2.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons3.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons4.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons5.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons6.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons7.png",name:"家居数码"},
				  {imgUrl:"../../static/img/icons8.png",name:"家居数码"}
			  ]
		  },
		  {
			  type:"hotList",
  ...
  res.json({
	  ...
	  data:[
		  ...
		  },
		  {
			  type:"iconsList",
			  data:[
				  {imgUrl:"../../static/img/icons1.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons2.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons3.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons4.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons5.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons6.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons7.png",name:"食品母婴"},
				  {imgUrl:"../../static/img/icons8.png",name:"食品母婴"}
			  ]
		  },
		  {
			  type:"hotList",
